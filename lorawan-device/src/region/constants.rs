...
pub(crate) const JOIN_ACCEPT_DELAY1: u32 = 6000;
pub(crate) const JOIN_ACCEPT_DELAY2: u32 = 7000;
pub(crate) const MAX_FCNT_GAP: usize = 16384;
pub(crate) const ADR_ACK_LIMIT: usize = 64;
pub(crate) const ADR_ACK_DELAY: usize = 32;
pub(crate) const ACK_TIMEOUT: usize = 3; // random delay between 1 and 3 seconds

pub(crate) const DEFAULT_BANDWIDTH: Bandwidth = Bandwidth::_250KHz;
pub(crate) const DEFAULT_SPREADING_FACTOR: SpreadingFactor = SpreadingFactor::_7;
pub(crate) const DEFAULT_CODING_RATE: CodingRate = CodingRate::_4_7;
